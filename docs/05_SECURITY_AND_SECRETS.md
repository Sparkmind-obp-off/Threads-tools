...
The application is a personal operator tool. Collect only data required for the selected features. Avoid retaining private content unless there is a clear product requirement and retention policy.
